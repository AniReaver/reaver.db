...
module.exports = class Json {
    constructor() {
        ...
        this.add = function (key, count) { if(!this.data[key]) this.data[key] = 0; this.data[key] = this.data[key] + count; this.save(); }
        ...
        this.subtract = function (key, count) { if(!this.data[key]) this.data[key] = 0; this.data[key] = this.data[key] - count; this.save(); }
