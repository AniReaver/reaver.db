...
module.exports = class Json {
    constructor() {
        ...
        this.store = (key) => { if(this.data[key]) throw new TypeError("No Need To Use db.store() Twice, Use db.get() Instead."); this.data[key] = null; this.save(); }
        this.get = (key) => { return this.data[key]; }
